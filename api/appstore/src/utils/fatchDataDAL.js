...
const getAll = function (collection) {
  return axios.get(`https://eitan-app-store.herokuapp.com/api/${collection}`);
};

const getOne = function (collection, id) {
  return axios.get(
    `https://eitan-app-store.herokuapp.com/api/${collection}/` + id
  );
};

const create = function (collection, obj) {
  return axios.post(
    `https://eitan-app-store.herokuapp.com/api/${collection}`,
    obj
  );
};
